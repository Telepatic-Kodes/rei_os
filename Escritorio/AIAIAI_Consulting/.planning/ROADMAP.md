...
- [x] Phase 7: Analytics & Charts — Recharts spend trends, model breakdown, burn rate
- [x] Phase 8: Budget Alerts & Notifications — Alert banners, settings UI, desktop + browser notifications
